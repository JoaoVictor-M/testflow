        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 overflow-hidden">
                <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-6">Não foi possível verificar a solicitação de redefinição de senha.</p>
                    <button onClick={() => navigate('/login')} className="text-blue-600 hover:text-blue-800 font-medium">Voltar para Login</button>
                </div>
            </div>
        )
    }
                    ...
                    <div className="relative group">
                        <div className="flex justify-between items-center mb-1">
                            ...
                            <div className="relative">
                                ...
                                {/* Tooltip */}
                                {showTooltip && (
                                    <div className="absolute right-0 bottom-full mb-2 w-64 p-3 bg-gray-800 text-white text-xs rounded shadow-lg z-50">
